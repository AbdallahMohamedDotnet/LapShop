...
namespace BL.Migrations
{
    ...
    [Migration("20250715040539_ideniti_package")]
    partial class ideniti_package
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LapShopv2.Models.TBSettings", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbBusinessInfo", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbCashTransacion", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbCategory", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbCustomer", b =>
                {
                    b.Property<int>("CustomerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItem", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItemDiscount", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItemImage", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItemType", b =>
                {
                    b.Property<int>("ItemTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbO", b =>
                {
                    b.Property<int>("OsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbPurchaseInvoice", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbPurchaseInvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbSalesInvoice", b =>
                {
                    b.Property<int>("InvoiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbSalesInvoiceItem", b =>
                {
                    b.Property<int>("InvoiceItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.TbSlider", b =>
                {
            ...
            modelBuilder.Entity("LapShopv2.Models.TbSupplier", b =>
                {
                    b.Property<int>("SupplierId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.VwItem", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.VwItemCategory", b =>
                {
                    b.Property<int>("CategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LapShopv2.Models.VwItemsOutOfInvoice", b =>
                {
                    b.Property<string>("CategoryName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("LapShopv2.Models.VwSalesInvoice", b =>
                {
                    b.Property<Guid>("CustomerId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetRole", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetRoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetUserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetUserLogin", b =>
                {
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetUserToken", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("AspNetUserRole", b =>
                {
                    b.HasOne("WebApplication1.Models.AspNetRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication1.Models.AspNetUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LapShopv2.Models.TbBusinessInfo", b =>
                {
                    b.HasOne("LapShopv2.Models.TbCustomer", "Cutomer")
                        .WithOne("TbBusinessInfo")
                        .HasForeignKey("LapShopv2.Models.TbBusinessInfo", "CutomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItem", b =>
                {
                    b.HasOne("LapShopv2.Models.TbCategory", "Category")
                        .WithMany("TbItems")
                        .HasForeignKey("CategoryId")
                        .IsRequired()
                        .HasConstraintName("FK_TbItems_TbCategories");

                    b.HasOne("LapShopv2.Models.TbItemType", "ItemType")
                        .WithMany("TbItems")
                        .HasForeignKey("ItemTypeId")
                        .HasConstraintName("FK_TbItems_TbItemTypes");

                    b.HasOne("LapShopv2.Models.TbO", "Os")
                        .WithMany("TbItems")
                        .HasForeignKey("OsId")
            ...
            modelBuilder.Entity("LapShopv2.Models.TbItemDiscount", b =>
                {
                    b.HasOne("LapShopv2.Models.TbItem", "Item")
            ...
            modelBuilder.Entity("LapShopv2.Models.TbPurchaseInvoice", b =>
                {
                    b.HasOne("LapShopv2.Models.TbSupplier", "Supplier")
            ...
            modelBuilder.Entity("LapShopv2.Models.TbPurchaseInvoiceItem", b =>
                {
                    b.HasOne("LapShopv2.Models.TbPurchaseInvoice", "Invoice")
            ...
            modelBuilder.Entity("LapShopv2.Models.TbSalesInvoiceItem", b =>
                {
                    b.HasOne("LapShopv2.Models.TbSalesInvoice", "Invoice")
            ...
            modelBuilder.Entity("TbCustomerItem", b =>
                {
                    b.HasOne("LapShopv2.Models.TbCustomer", null)
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LapShopv2.Models.TbItem", null)
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetRoleClaim", b =>
                {
                    b.HasOne("WebApplication1.Models.AspNetRole", "Role")
            ...
            modelBuilder.Entity("WebApplication1.Models.AspNetUserClaim", b =>
                {
                    b.HasOne("WebApplication1.Models.AspNetUser", "User")
